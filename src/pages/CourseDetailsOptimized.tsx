...
const CourseDetailsOptimized = () => {
    ...
    const toggleFavorite = useCallback(async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                // Refresh course data to get updated favorite status
                await refresh();
            } else {
                toast({
                    title: "خطأ",
    ...
    }, [courseId, isAuthenticated, isTogglingFavorite, toast, refresh]);
...
export default CourseDetailsOptimized; 