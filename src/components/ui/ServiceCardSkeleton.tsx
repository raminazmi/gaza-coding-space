...
const ServiceCardSkeleton = () => (
  <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 animate-pulse relative overflow-hidden">
    ...
    {/* صورة وهمية */}
    <div
      className="w-full aspect-video rounded-xl mb-6 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-800 dark:to-gray-700"
      style={{
