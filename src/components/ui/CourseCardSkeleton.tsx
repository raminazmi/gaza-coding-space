...
const CourseCardSkeleton = () => (
  <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 animate-pulse relative overflow-hidden">
    <style>{shimmer}</style>
    {/* صورة أو فيديو وهمي */}
    <div
      className="w-full h-48 md:h-64 rounded-xl mb-6 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-800 dark:to-gray-700"
      style={{
